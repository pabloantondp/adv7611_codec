...
ifneq ($(KERNELRELEASE),)
	obj-m := adv7611_codec.o

# Otherwise we were called directly from the command
# line; invoke the kernel build system.
else
	KERNELDIR ?= /home/pablo/Projects/vodabox3/poky/build/tmp/work/vodabox3-poky-linux-gnueabi/linux-vodalys/3.18+gitAUTOINC+15424e20ae-r0/git
	PWD := $(shell pwd)
default:
